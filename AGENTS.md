...
This directory is the authoritative root for **agent-workspace-continuity-template**. Treat it as one scoped project, not as a general machine-level memory store.
